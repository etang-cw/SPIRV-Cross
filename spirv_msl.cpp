...
#define PACKED_FORMAT(log2_align, elems, packing, type, order) FORMAT(log2_align, elems, packing, type, true, order, false)
	static constexpr std::pair<MSLFormat, MSLFormatInfo> s_vertex_info_entries[] = {
		...
		{ MSL_FORMAT_A8B8G8R8_SRGB_PACK32,    SIMPLE_FORMAT_VK_PACKED(0, 4, SRGB,  RGB) },
		...
		{ MSL_FORMAT_R8_SRGB,          SIMPLE_FORMAT(0, 1, SRGB,  RGB) },
		...
		{ MSL_FORMAT_R8G8_SRGB,        SIMPLE_FORMAT(0, 2, SRGB,  RGB) },
		...
		{ MSL_FORMAT_R8G8B8_SRGB,      SIMPLE_FORMAT(0, 3, SRGB,  RGB) },
		...
		{ MSL_FORMAT_B8G8R8_SRGB,      SIMPLE_FORMAT(0, 3, SRGB,  BGR) },
		...
		{ MSL_FORMAT_R8G8B8A8_SRGB,    SIMPLE_FORMAT(0, 4, SRGB,  RGB) },
		...
		{ MSL_FORMAT_B8G8R8A8_SRGB,    SIMPLE_FORMAT(0, 4, SRGB,  BGR) },
