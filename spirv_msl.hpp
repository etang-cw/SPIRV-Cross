...
/// TODO: Can we just import VkVertexInputRate
...
/// TODO: Can we just import VkFormat?
...
enum class MSLFormatPacking : uint8_t
{
...
struct MSLFormatInfo
{
	...
	bool is_packed : 1; ///< Is packed in MSL
	bool vk_packed : 1; ///< Is packed in Vulkan but not MSL
	bool is_bgr : 1;
	bool is_srgb : 2; // + padding
